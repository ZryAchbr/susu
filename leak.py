...
global file_types
file_types = ['doc', 'docx', 'ppt', 'pptx', 'csv', 'pdf', 'xls', 'xlsx', 'sql', 'txt']
global user_agents
...
def banner():
    ...
    print('                █   ▀                  ')
    print('               ▀                       ')
    print('          Get Leaked Data (website)                        ')
    print('                            Version 2.0                              ')
    print('                       A project by ./Itingss                         ')
    print('')
    print('                  python3 leak.py -h untuk Mulai                    ' + Style.RESET_ALL)
    print("-" * 73)
...
def msdorker():
    ...
    for files in file_types:
        try:
            ...
            print(info + f'[Searching Info..] Dumpper Database From Site for {files} extensions.')
